      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Every morning, get 10 startup ideas scraped from Reddit, HN, and Twitter&mdash;scored by opportunity, with technical specs included.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Building first, validating later&mdash;then realizing nobody wants what you made.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm">
              <div className="text-4xl mb-4">&#x1F4AD;</div>
      ...
      <section id="features" className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-16 max-w-2xl mx-auto">
            From raw social media posts to validated business briefs&mdash;fully automated, delivered daily.
          </p>
