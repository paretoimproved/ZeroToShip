...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "1 full brief per week", included: true },
      { text: "Email delivery", included: true },
      { text: "No archive access", included: false },
      { text: "No search or validation", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Idea validation (2/day)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "50 briefs/day + overage", included: true },
      { text: "API access & keys", included: true },
      { text: "Export to Notion/CSV", included: true },
      { text: "10 validations per day", included: true },
