...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "api_keys_key_idx" ON "api_keys" ("key");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ideas_priority_idx" ON "ideas" ("priority_score");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ideas_published_at_idx" ON "ideas" ("published_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ideas_category_idx" ON "ideas" ("category");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ideas_effort_idx" ON "ideas" ("effort_estimate");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "rate_limits_identifier_idx" ON "rate_limits" ("identifier");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "rate_limits_window_idx" ON "rate_limits" ("window_end");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "saved_ideas_user_idx" ON "saved_ideas" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "saved_ideas_idea_idx" ON "saved_ideas" ("idea_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "users_email_idx" ON "users" ("email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "viewed_ideas_user_idx" ON "viewed_ideas" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "viewed_ideas_idea_idx" ON "viewed_ideas" ("idea_id");--> statement-breakpoint
DO $$ BEGIN
